...
$sql="SELECT * FROM `duty` WHERE CONCAT(`id`, `name`, `contacts`) LIKE '%".$valuetosearch."%'"; 
$search_result= filtertable($sql);
}
else{
$sql="SELECT * FROM `duty`  ORDER BY `date`";
$search_result=filtertable($sql);
...
<ul class="navbar-nav  mt-lg-0 mx-auto">
    <li class="nav-item">
        <a style="color: darkgreen; font-family:Verdana; font-weight: bolder;" >DUTY ASSIGNMENT REPORT</a>
      </li>
...
<th scope="col"><strong>TIME REPORTED</strong></th>
<th scope="col"><strong>DUTY/RESPONSIBILITY</strong></th>
