...
$sql="SELECT * FROM `officer` WHERE CONCAT(`id`, `name`) LIKE '%".$valuetosearch."%'"; 
$search_result= filtertable($sql);
}
else{
  $ac="Suspended";
$sql="SELECT * FROM `officer` where status='Suspended'";
$search_result=filtertable($sql);
...
<ul class="navbar-nav  mt-lg-0 mx-auto">
    <li class="nav-item">
        <a style="color: darkgreen; font-family:Verdana; font-weight: bolder;" >SUSPENDED OFFICERS</a>
      </li>
